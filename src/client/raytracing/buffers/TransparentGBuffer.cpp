...
void TransparentGBuffer::create(
    VkDevice device,
...
void TransparentGBuffer::createAttachment(
    VkDevice device,
    VkPhysicalDevice physicalDevice,
    Image& attachment,
    VkFormat format,
...
)
{
        ...
        ) != VK_SUCCESS)
    {
        throw std::runtime_error(
            "Failed to create TransparentGBuffer attachment sampler"
        );
    }
}

void TransparentGBuffer::destroy(VkDevice device)
{
...
void TransparentGBuffer::destroyAttachment(
    VkDevice device,
    Image& attachment
)
{
...
VkImage TransparentGBuffer::getImage(Attachment attachment) const
{
    switch (attachment)
    {
...
VkImageView TransparentGBuffer::getView(Attachment attachment) const
{
    switch (attachment)
    {
...
VkFormat TransparentGBuffer::getFormat(Attachment attachment) const
{
    switch (attachment)
    {
...
VkSampler TransparentGBuffer::getSample(Attachment attachment) const
{
    switch (attachment)
    {
...
VkExtent2D TransparentGBuffer::getExtent() const
{
    return extent;
}

VkSampleCountFlagBits TransparentGBuffer::getSamples() const
{
    return samples;
}

std::array<VkImageView, 4> TransparentGBuffer::getColorViews() const
{
    return {
        position.view,
        normal.view,
